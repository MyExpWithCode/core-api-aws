...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241023051015_ClassWithForeignKey') THEN
    ALTER TABLE sample_poc."Students" RENAME COLUMN "ClassId" TO "StudentClassId";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241023051015_ClassWithForeignKey') THEN
    CREATE INDEX "IX_Students_StudentClassId" ON sample_poc."Students" ("StudentClassId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241023051015_ClassWithForeignKey') THEN
    ALTER TABLE sample_poc."Students" ADD CONSTRAINT "FK_Students_Classes_StudentClassId" FOREIGN KEY ("StudentClassId") REFERENCES sample_poc."Classes" ("Id") ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241023051015_ClassWithForeignKey') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20241023051015_ClassWithForeignKey', '9.0.0-rc.2.24474.1');
    END IF;
END $EF$;
COMMIT;
